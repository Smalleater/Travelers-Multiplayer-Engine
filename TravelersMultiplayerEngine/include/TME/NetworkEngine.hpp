...
namespace tme
{
    ...
    public:
        ...
        public:
            ...
            static TME_API ErrorCodes SendReliableToAll(const std::vector<uint8_t>& message);
        };
        ...
        public:
            ...
            static TME_API ErrorCodes GetReceivedReliableThisTick(std::vector<std::vector<uint8_t>>& outMessages);

            static TME_API ErrorCodes SendReliable(const std::vector<uint8_t>& message);
        };
    };
}